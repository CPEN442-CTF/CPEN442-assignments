...
class Protocol:
    ...
    def __init__(self):
        ...
        self._g             = 0xFFFFAADCCC2833827878273
    ...
    def ProcessReceivedProtocolMessage(self, message, secret):
        ...
        if self._MWait == None:
            ...
            self.SetSessionKey(1) # For now put 1, still waiting for the decryption implmentation, so i can get the DH part key from the received message.
            pass
